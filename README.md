...
- [Invoice Flow](https://github.com/aleavenger/invoice-flow) — AI invoice automation SaaS
- [PaperclipAI](https://github.com/aleavenger/paperclipai) — AI orchestration platform managing development agents
